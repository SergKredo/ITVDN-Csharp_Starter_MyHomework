...
namespace Task_2
{
    class Program
    {
        static void Main()
        {
            ...
            //Создание переменной и инициализация переменной значением полученным из стандартного входного потока.
            double x = Convert.ToDouble(Console.ReadLine());
            //Проверка, входит ли число в промежуток указанный в условии.
            if ((x >= 0) && (x <= 14))
            {
